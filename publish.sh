...
echo "  https://github.com/nickprotop/cxpost/actions"
echo ""
echo "Release will be at:"
echo "  https://github.com/nickprotop/cxpost/releases/tag/$NEW_TAG"
